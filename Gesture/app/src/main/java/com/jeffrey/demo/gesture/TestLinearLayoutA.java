...
public class TestLinearLayoutA extends LinearLayout {
    private static final String DEBUG_TAG = TestLinearLayoutA.class.getSimpleName();
    ...
    public TestLinearLayoutA(Context context) {
        super(context);
    }

    public TestLinearLayoutA(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public TestLinearLayoutA(Context context, AttributeSet attrs, int defStyleAttr) {
